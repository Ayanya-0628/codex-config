...
- ‚ú?Correct: `<div><p>Text here</p></div>`
- ‚ù?Wrong: `<div>Text here</div>` - **Text will NOT appear in PowerPoint**
- ‚ù?Wrong: `<span>Text</span>` - **Text will NOT appear in PowerPoint**
...
- ‚ú?Web-safe fonts: `Arial`, `Helvetica`, `Times New Roman`, `Georgia`, `Courier New`, `Verdana`, `Tahoma`, `Trebuchet MS`, `Impact`, `Comic Sans MS`
- ‚ù?Wrong: `'Segoe UI'`, `'SF Pro'`, `'Roboto'`, custom fonts - **Might cause rendering issues**
...
- ‚ú?Correct: `color: "FF0000"`, `fill: { color: "0066CC" }`
- ‚ù?Wrong: `color: "#FF0000"` (breaks document)
