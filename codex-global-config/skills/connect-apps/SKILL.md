...
- **"Plugin not found"** 鈫?Make sure you ran `/plugin install composio-toolrouter`
- **"Need to authorize"** 鈫?Click the OAuth link Claude provides, then say "done"
- **Action failed** 鈫?Check you have permissions in the target app
