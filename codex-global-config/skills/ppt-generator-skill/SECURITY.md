...
# 6. 关联远程仓库
git remote add origin https://github.com/你的用户�?ppt-generator.git
...
**2. 从Git历史中删除敏感信�?*
```bash
# 使用 git filter-branch �?BFG Repo-Cleaner
# 删除历史记录中的敏感文件
...
- [ ] 运行 `grep -r "AIzaSy" .` 确认密钥只在 `.env` �?
- [ ] `.env.example` 只包含模板，不包含真实密�?
